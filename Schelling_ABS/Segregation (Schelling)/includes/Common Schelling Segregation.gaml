...
global {
	...
	float density_of_people <- 0.7 parameter: "Density of people:" category: "Population" min: float (0) max: float (1) ;
	...
	int num_sim <- 0 max: 100 min: -1 parameter: "number of the simulation" category: "Environment";
