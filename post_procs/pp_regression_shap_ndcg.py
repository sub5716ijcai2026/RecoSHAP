...
# =============================================================================
# # add this to your `models` dict (replace the previous "CIEL" entry)
# "CIEL": (
#     CIELRegressor(seed=SEED),          # default constructor uses SEED
#     {
#         "alpha":        [0.1, 0.2],     # activation alpha
#         "l1":           [ 0.1, 0.2],      # L1 regularization
#         "memory_length": [5, 10, 20],        # memory length for LinearWithMemory
#         "R":            [0.3, 0.5, 0.8],     # R parameter for Trainer
#     }
# ),
# 
#   "PCE": (
...
# =============================================================================
#     "RMTS": (
#         SMTWrapper(RMTC, regularization_weight=0.001,   xlimits=np.array([[0,1]]*np.shape(DATABASEx)[1]).astype('double'), print_global=False, seed=SEED),
#         {"approx_order" : [3,4,5],
#          }
#     ),
#     "TabPFN": (
...
datasets = ["LEV", "ESL", "analcatdata_apnea1", "ERA", "pm10", "Wine_Quality", "pollen","Abalone", "cpu_small","satellite_image","wind", "puma8NH","pol","BNG_lowbwt","houses"]


# =============================================================================
# datasets = ["LEV", "ESL", "analcatdata_apnea1", "ERA"]
# 
# datasets = ["Adult", "ESL", "analcatdata_apnea1", "ERA"]
# 
# =============================================================================
...
for d_idx, dataset in enumerate(datasets):
    ...
    # Load SHAP values for this datasemùt
...
# Show the plot
#plt.savefig("ndcg_medium.png", dpi=350, bbox_inches='tight')
#plt.tight_layout()
plt.show()
